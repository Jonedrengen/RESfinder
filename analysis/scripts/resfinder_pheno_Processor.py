...
# Changed: Jon Slotved (JOSS@ssi.dk) on 05/01/25 (Thank you to Edward Sung for initial script)
...
# Testing Purposes
# dir_path = "/Users/B328695/Desktop/RESfinder/resfinder_analysis/test_output/processing_files"
...
i = 0
tmp_template_file = dir_path + "/" + folderList[i] +  "/pheno_table.txt"
...
for folder in folderList:
    ...
    filepath = dir_path + "/" + folder + "/pheno_table.txt" # Extract data from pheno_table.txt
